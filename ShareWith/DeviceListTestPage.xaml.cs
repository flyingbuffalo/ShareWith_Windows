...
namespace ShareWith
{
    ...
    public sealed partial class DeviceListTestPage : Page
    {
        ...
        public void DrawDeviceList()
        {
            double width = canvasGrid.ActualWidth, height = canvasGrid.ActualWidth;

            ImageButton andBtn = new ImageButton();
            andBtn.Style = canvasGrid.Resources["styleBtnAndroid"] as Style;
            Canvas.SetLeft(andBtn, 200);
            Canvas.SetTop(andBtn, 200);


            ImageButton comBtn = new ImageButton();
            comBtn.Style = canvasGrid.Resources["styleBtnComputer"] as Style;
            Canvas.SetLeft(comBtn, 600);
            Canvas.SetTop(comBtn, 200);

            canvasGrid.Children.Add(andBtn);
            canvasGrid.Children.Add(comBtn);
        }
    }
}
